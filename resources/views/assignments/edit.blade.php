...
@section('pageTitle', "Edit $courseClass->name Assessment")
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    ...
                    <div class="flex flex-row flex-wrap justify-between px-10 pt-10 ">
                        <div class=" ">
                            <div class="pt-1">
                                <div>
                                    <h1 class="font-bold">Assessment Plan</h1>
                                    <p class="text-gray-400 text-sm pb-2">Assessment plan can only be used once per class</p>
                                    <div class="form-control w-full lg:w-[28.5rem] ">
                                        <select name="assignment_plan_id" class="select select-bordered">
                                            <option disabled selected>Choose the assessment plan</option>
                        ...
                        <div class="flex flex-col">
                            <div class="title font-bold pt-2">
                                <h1>Note</h1>
                            </div>
                            <div class="py-2">
                                <div>
