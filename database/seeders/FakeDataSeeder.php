                            ...
                            ->each(function ($study_program) use ($admin) {
                                ...
                                Course::factory(1)
                                    ...
                                    ->each(function ($course) use ($teachers) {
                                        $teacher_creator_id = $teachers
                                            ->random(1)
                                            ->first()->id;
                                        $syllabi = Syllabus::factory(2)
                                            ->create([
                                                "course_id" => $course->id,
                                            ...
                                            ->each(function ($syllabus) {
                                                ...
                                                $nCourseOutcome = 6;
                                                $courceOutcomeMap = $this->rangeWithN(
                                                    0,
                                                    count($ilos) - 1,
                                                    $nCourseOutcome,
                                                );
                                                ...
                                                $nLessonOutcome = 6;
                                                $lessonOutcomeMap = $this->rangeWithN(
                                                    0,
                                                    count($clos) - 1,
                                                    $nLessonOutcome,
                                                );
                                                ...
                                                $nLearningPlan = 16;
                                                $learningPlanMap = $this->rangeWithN(
                                                    0,
                                                    count($llos) - 1,
                                                    $nLearningPlan,
                                                );
                                                ...
                                                $learningPlans = collect(
                                                    $learningPlans,
                                                );

                                                $numberOfAssignments = 8;
                                                $learningPlanIdx = 0;
                                                AssignmentPlan::factory(
                                                    $numberOfAssignments,
                                                )
                                                    ->create([
                                                        "syllabus_id" =>
                                                    ...
                                                    ->each(function (
                                                        ...
                                                        $assignmentPlanTasks = AssignmentPlanTask::factory(
                                                            $numberOfAssignmentPlanTasks,
                                                        )->create([
                                                            "assignment_plan_id" =>
                                                                $assignmentPlan->id,
                                                        ]);
                                                        ...
                                                        $numberOfAssignmentPlanTasks = count(
                                                            $assignmentPlanTasks,
                                                        );
                                                        $criteriaMaxPoint =
                                                            100 /
                                                        ...
                                                        foreach (
                                                            ...
                                                            $assignmentPlanTask->criteria_id =
                                                                $criteria->id;
                                        ...
                                        foreach ($syllabi as $syllabus) {
                                            CourseClass::factory(2)
                                                ...
                                                ->each(function (
                                                    ...
                                                    $studentsJoinThisClass = User::factory(
                                                        rand(30, 40),
                                                    )
                                                        ->create([
                                                            "role" => "student",
                                                    ...
                                                    $course_class
                                                        ->students()
                                                        ->attach(
                                                            $studentsJoinThisClass,
                                                        );

                                                    $assignmentPlans =
                                                        $course_class->syllabus
                                                            ->assignmentPlans;
                                                    ...
                                                    foreach (
                                                        ...
                                                        $assignmentPlanTasks =
                                                            $assignmentPlan->assignmentPlanTasks;

                                                        foreach (
                                                            $studentsJoinThisClass
                                                            as $student
                                                        ) {
                                                            $studentGrade = StudentGrade::factory(
                                                                1,
                                                            )
                                                                ->create([
                                                                    "student_user_id" =>
                                                            ...
                                                            foreach (
                                                                ...
                                                                if (
                                                                    in_array(
                                                                        $student,
                                                                        $studentWithGoodGrade,
                                                                    )
                                                                ) {
                                                                    $criteriaLevel = $criteriaLevels->get(
                                                                        rand(
                                                                            0,
                                                                            1,
                                                                        ),
